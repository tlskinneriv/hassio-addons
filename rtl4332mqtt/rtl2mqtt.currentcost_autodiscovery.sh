...
#  echo $DEVICE
  DEVICEID="$(echo $line | jq --raw-output '.dev_id' | tr -s ' ' '_')"
#  echo $DEVICEID
  MQTT_PATH="${MQTT_TOPIC}/${DEVICE}_${DEVICEID}"
#  echo $MQTT_PATH
